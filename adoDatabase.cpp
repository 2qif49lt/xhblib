...
BOOL CADORecordset::Requery()
{
	if(IsOpen())
	{
		try
		{
			//m_pRecordset->Requery(adExecuteRecord); //±àÒëÒª³ö´í
		}
		catch(_com_error &e)
		{
			dump_com_error(e);
...
BOOL CADORecordset::GetFieldValue(int nIndex, char& cValue)
{
	_variant_t vtFld;
	_variant_t vtIndex;
	...
	try
	{
		...
		{
		case VT_BOOL:
			cValue = (char) vtFld.boolVal ;
			break;
		case VT_I1:
			cValue = vtFld.cVal; 
			break;
		case VT_UI1:
			cValue = (char)vtFld.bVal; 
			break;
		default:
			return FALSE;
		}	
...
BOOL CADORecordset::GetFieldValue(LPCTSTR lpFieldName, char& cValue)
{
	_variant_t vtFld;
	try
	{
...
BOOL CADORecordset::GetFieldValue(int nIndex, unsigned char& ucValue)
{
	_variant_t vtFld;
	_variant_t vtIndex;
	...
	try
	{
		...
		{
		case VT_BOOL:
			ucValue = (unsigned char) vtFld.boolVal ;
			break;
		case VT_I1:
			ucValue = (unsigned char )vtFld.cVal; 
			break;
		case VT_UI1:
			ucValue = vtFld.bVal; 
			break;
...
BOOL CADORecordset::GetFieldValue(int nIndex, short& nValue)
{
	_variant_t vtFld;
	_variant_t vtIndex;
	...
	try
	{
		...
		{
		case VT_BOOL:
			nValue = (short) vtFld.boolVal ;
			break;
		case VT_I1:
			nValue = (short)vtFld.cVal; 
			break;
		case VT_UI1:
			nValue = (short)vtFld.bVal; 
			break;
		case VT_I2:
			nValue = vtFld.iVal; 
			break;
		case VT_UI2:
			nValue = (short)vtFld.uiVal;
		default:
			return FALSE;
		}	
		return TRUE;
...
BOOL CADORecordset::GetFieldValue(LPCTSTR lpFieldName, short& nValue)
{
	_variant_t vtFld;
	try
	{
...
BOOL CADORecordset::GetFieldValue(int nIndex, unsigned short& unValue)
{
	_variant_t vtFld;
	_variant_t vtIndex;
	...
	try
	{
		...
		{
		case VT_BOOL:
			unValue = (unsigned short) vtFld.boolVal ;
			break;
		case VT_I1:
			unValue = (unsigned short)vtFld.cVal; 
			break;
		case VT_UI1:
			unValue = (unsigned short)vtFld.bVal; 
			break;
		case VT_I2:
			unValue = (unsigned short)vtFld.iVal; 
			break;
		case VT_UI2:
			unValue = vtFld.uiVal;
			break;
...
BOOL CADORecordset::GetFieldValue(LPCTSTR lpFieldName, unsigned short& unValue)
{
	_variant_t vtFld;
	try
	{
...
BOOL CADORecordset::GetFieldValue(int nIndex, long& lValue)
{
	...
	try
	{
		...
		{
		case VT_BOOL:
			lValue = (long) vtFld.boolVal ;
			break;
		case VT_I1:
			lValue = (long)vtFld.cVal; 
			break;
		case VT_UI1:
			lValue = (long)vtFld.bVal; 
			break;
		case VT_I2:
			lValue = (long)vtFld.iVal; 
			break;
		case VT_UI2:
			lValue = (long)vtFld.uiVal;
			break;
		case VT_I4:
			lValue = vtFld.lVal;
			break;
		case VT_INT:
			...
			break;
		case VT_UI4:
			lValue = (long)vtFld.ulVal;
			break;
		case VT_UINT:
			lValue = (long)vtFld.uintVal;
			break;
		default:
			return FALSE;
		}	
...
BOOL CADORecordset::GetFieldValue(int nIndex, unsigned long& ulValue)
{
	...
	try
	{
		...
		{
		case VT_BOOL:
			ulValue = (unsigned long) vtFld.boolVal ;
			break;
		case VT_I1:
			ulValue = (unsigned long)vtFld.cVal; 
			break;
		case VT_UI1:
			ulValue = (unsigned long)vtFld.bVal; 
			break;
		case VT_I2:
			ulValue = (unsigned long)vtFld.iVal; 
			break;
		case VT_UI2:
			ulValue = (unsigned long)vtFld.uiVal;
			break;
		case VT_I4:
			ulValue = (unsigned long)vtFld.lVal;
			break;
		case VT_INT:
			ulValue = (unsigned long)vtFld.intVal;
			break;
		case VT_UI4:
			ulValue = vtFld.ulVal;
			break;
		case VT_UINT:
			ulValue = vtFld.uintVal;
			break;
		default:
			return FALSE;
...
BOOL CADORecordset::GetChunk(LPCTSTR lpFieldName, LPVOID lpData,long& lDataLen)
{
	FieldPtr pField = m_pRecordset->Fields->GetItem(lpFieldName);

	return GetChunk(pField, lpData,lDataLen);

}

BOOL CADORecordset::GetChunk(int nIndex, LPVOID lpData,long& lDataLen)
{
	_variant_t vtIndex;
...
BOOL CADORecordset::GetChunk(FieldPtr pField, LPVOID lpData,long& lDataLen)
{
	_variant_t varChunk;    
	lDataLen = pField->ActualSize;
	try
	{
		varChunk = pField->GetChunk(lDataLen);
		BYTE *buf = NULL;
		SafeArrayAccessData(varChunk.parray, (void **)&buf);
		memcpy(lpData,buf,lDataLen);
...
BOOL CADORecordset::SetFieldValue(int nIndex, char cValue)
{
	_variant_t vtFld;
	vtFld.vt = VT_I1;
	vtFld.cVal = cValue;
...
BOOL CADORecordset::SetFieldValue(LPCTSTR lpFieldName, char cValue)
{
	_variant_t vtFld;
	vtFld.vt = VT_I1;
	vtFld.cVal = cValue;
...
BOOL CADORecordset::SetFieldValue(int nIndex, unsigned char ucValue)
{
	_variant_t vtFld;
	vtFld.vt = VT_UI1;
	vtFld.bVal = ucValue;
...
BOOL CADORecordset::SetFieldValue(LPCTSTR lpFieldName, unsigned char ucValue)
{
	_variant_t vtFld;
	vtFld.vt = VT_UI1;
	vtFld.bVal = ucValue;
...
BOOL CADORecordset::SetFieldValue(int nIndex, short nValue)
{
	_variant_t vtFld;
	vtFld.vt = VT_I2;
	vtFld.iVal = nValue;
...
BOOL CADORecordset::SetFieldValue(LPCTSTR lpFieldName, short nValue)
{
	_variant_t vtFld;
	vtFld.vt = VT_I2;
	vtFld.iVal = nValue;
...
BOOL CADORecordset::SetFieldValue(int nIndex, unsigned short unValue)
{
	_variant_t vtFld;
	vtFld.vt = VT_UI2;
	vtFld.uiVal = unValue;
...
BOOL CADORecordset::SetFieldValue(LPCTSTR lpFieldName, unsigned short unValue)
{
	_variant_t vtFld;
	vtFld.vt = VT_UI2;
	vtFld.uiVal = unValue;
...
BOOL CADOCommand::AddParameter(CString strName, int nType, int nDirection, long lSize, _variant_t vtValue, int nPrecision, int nScale)
{
	try
	{
		_ParameterPtr pParam = m_pCommand->CreateParameter(_bstr_t(strName), (DataTypeEnum)nType, (ParameterDirectionEnum)nDirection, lSize, vtValue);
...
CADOParameter::CADOParameter(int nType, long lSize, int nDirection, CString strName)
{
	...
	m_strName = strName;
	m_pParameter->Name = _bstr_t(m_strName);
...
void CADOParameter::SetParam(int nType, long lSize, int nDirection, CString strName)
{
	m_pParameter = NULL;
	m_pParameter.CreateInstance(__uuidof(Parameter));
	m_strName = _T("");
...
BOOL CADOParameter::SetValue(BYTE btValue)
{
	_variant_t vtVal;
...
BOOL CADOParameter::SetValue(short nValue)
{
	_variant_t vtVal;
...
BOOL CADOParameter::SetValue(unsigned short nValue)
{
	_variant_t vtVal;
	...
	{
		if(m_pParameter->Size == 0)
			m_pParameter->Size = sizeof(unsigned short);
...
BOOL CADOParameter::SetValue(unsigned long lValue)
{
	_variant_t vtVal;
	...
	{
		if(m_pParameter->Size == 0)
			m_pParameter->Size = sizeof(unsigned long);
...
BOOL CADOParameter::GetValue(short& nValue)
{
	_variant_t vtVal;
	short nVal = 0;
...
BOOL CADOParameter::GetValue(unsigned short& nValue)
{
	_variant_t vtVal;
...
BOOL CADOParameter::GetValue(unsigned long& lValue)
{
	_variant_t vtVal;
