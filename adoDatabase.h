...
public:
	...
	BOOL GetFieldValue(int nIndex, char& cValue);
	BOOL GetFieldValue(LPCTSTR lpFieldName, char& cValue);

	BOOL GetFieldValue(int nIndex, unsigned char& ucValue);
	BOOL GetFieldValue(LPCTSTR lpFieldName, unsigned char& ucValue);

	BOOL GetFieldValue(int nIndex, short& nValue);
	BOOL GetFieldValue(LPCTSTR lpFieldName, short& nValue);

	BOOL GetFieldValue(int nIndex, unsigned short& unValue);
	BOOL GetFieldValue(LPCTSTR lpFieldName, unsigned short& unValue);
	...
	BOOL SetFieldValue(int nIndex, char cValue);
	BOOL SetFieldValue(LPCTSTR lpFieldName, char cValue);

	BOOL SetFieldValue(int nIndex, unsigned char ucValue);
	BOOL SetFieldValue(LPCTSTR lpFieldName, unsigned char ucValue);

	BOOL SetFieldValue(int nIndex, short nValue);
	BOOL SetFieldValue(LPCTSTR lpFieldName, short nValue);

	BOOL SetFieldValue(int nIndex, unsigned short unValue);
	BOOL SetFieldValue(LPCTSTR lpFieldName, unsigned short unValue);
	...
	BOOL GetChunk(LPCTSTR lpFieldName, LPVOID pData,long& lDataLen);
	BOOL GetChunk(int nIndex, LPVOID pData,long& lDataLen);
...
protected:
	...
	BOOL GetChunk(FieldPtr pField, LPVOID lpData,long& lDataLen);
...
public:
	...
	CADOParameter();
	void SetParam(int nType, long lSize = 0, int nDirection = paramInput, CString strName = _T(""));
	...
	BOOL SetValue(unsigned short nValue);
	BOOL SetValue(long lValue);
	BOOL SetValue(unsigned long lValue);
	...
	BOOL GetValue(short& nValue);
	BOOL GetValue(unsigned short& nValue);
	BOOL GetValue(long& lValue);
	BOOL GetValue(unsigned long& lValue);
